...
from src.data.repositories.pandas.save_load_data_object import save_data_objects
...
if __name__ == '__main__':
    ...
    pharma_company_data_dicts = list(map(lambda data_object: data_object.data_dict, data_objects))
    save_data_objects(pharma_company_data_objects)
    pharma_company_data_dicts = list(map(lambda data_object: data_object.data_dict, data_objects))
    save_data_objects(pharma_company_data_objects)
    ...
    save_data_objects(ppp_data_objects)
